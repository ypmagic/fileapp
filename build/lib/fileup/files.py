...
def file_upload():
    ...
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            secure_file_path = os.path.join(UPLOAD_FOLDER, secure_file_name)
...
def download_file(id):
    ...
    if os.path.isfile(os.path.join(UPLOAD_FOLDER, secure_file_name)):
    ...
    # download file
    try:
        s3_client.download_file(S3_BUCKET, secure_file_name, os.path.join(UPLOAD_FOLDER, secure_file_name))
